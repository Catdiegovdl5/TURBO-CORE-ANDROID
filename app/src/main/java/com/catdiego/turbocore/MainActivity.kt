            ...
            LaunchedEffect(Unit) {
                ...
                if (Shizuku.pingBinder()) {
                    ...
                    try {
                        ...
                        shizukuStatus = "Erro ao solicitar permissão"
                    }
                } else {
            ...
            Box(modifier = Modifier.fillMaxSize().background(Color(0xFF0A0A0A))) {
                LazyColumn(modifier = Modifier.padding(16.dp)) {
                    item {
                        ...
                        Button(onClick = {
                            scope.launch { terminalLog = AppManager.runCommand("wm density 180") }
                        ...
                        Button(onClick = {
                            scope.launch { terminalLog = AppManager.runCommand("wm size reset && wm density reset && settings put global low_power 0") }
